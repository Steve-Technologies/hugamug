if (document.querySelector("#chart")) {
  let api_url = "./test_admin_apis/chart_data.json";
  ...
  function amt_qty_swap(btn) {
    ...
    if (chart_data[active_tab.id][metric_to_change].length != 0) {
      ...
      btn.children[0].innerText =
        btn.dataset.metric === "amount" ? "stacks" : "attach_money";
      btn.children[1].innerText =
        btn.dataset.metric === "amount" ? "Qty" : "Amount";
...
let orders;
let orders_api_url = "./test_admin_apis/order_data.json";
